		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="form-line">
						<input type="text" class="form-control" placeholder="Ex: blablacrocxxx" name="username" required
							autocomplete="off" />
					</div>
				</div>
				<div class="form-group">
			...
			<div class="modal-footer">
				...
				<input type="submit" class="btn btn-primary pull-right"
					style="margin-right: 20px;font-size: 16px;height: 40px;width: 100px;" value="SIMPAN" name="submit">
			</div>
