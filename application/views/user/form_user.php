            ...
            <link href="<?= base_url(); ?>assets/AdminBsb/plugins/bootstrap-select/css/bootstrap-select.css"
            	rel="stylesheet" />
            					...
            					<div class="body">
            								...
            								<div class="form-group">
            									<div class="form-line">
            										<input type="text"
            											...
            											class="form-control" placeholder="Ex : Nama " name="nama"
            								...
            								<div class="form-group">
            									<div class="form-line">
            										<input type="text"
            											...
            											class="form-control" placeholder="Ex: blablacrocxxx"
            											name="username" required autocomplete="off"
            											<?= isset($user['username']) ? 'readonly' : ''; ?> />

            									</div>
            									<span style="color: red;">*<small>Note : username tidak bisa
            											diubah/edit</small></span>
            								</div>
            							</div>
            						</div>
            						...
            						<div class="row clearfix">
            							...
            							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
            								<div class="form-group">
            									<div class="form-line">
            										<input type="password" class="form-control" placeholder="Ex: xxxxx"
