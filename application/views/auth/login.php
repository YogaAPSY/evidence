...
<head>
	...
	<style>
		...
		<blade media|%20only%20screen%20and%20(max-width%3A%20600px)%20%7B>.max {
			margin: auto;
		}
...
<body class="login-page"
	style=" background: linear-gradient(to right, rgba(2,0,36,1) 0%, rgba(45,45,148,1) 35%, rgba(0,212,255,1) 100%);">
	...
	<div class="login-box maxmax">
		...
		<div class="logo">
			<img src="<?= base_url(); ?>assets/login/img/apoteker.png"
				style="margin-bottom:20px; width:120px; height:120px; position: relative;"
				class="responsive-image center-block">
			<a href="javascript:void(0);"><b style="font-size: 40px">EVIDENCE</b></a>
			<small style="font-size: 17px">Sistem Pengelolaan Administrasi Kontrak</small>
		</div>
		...
		<div class="card" style="border-radius: 25px !important;">
			<div class="body">
				...
				<div class="msg" style="margin-top:20px; font-weight: bold; color: red;">Silahkan login terlebih dahulu
				</div>
				...
				<div class="row">
					...
					<div class="col-xs-4">
						...
						<input type="submit" name="login" value="Masuk" class="btn btn-block bg-pink waves-effect">
...
<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xs-12"
	style="padding-left:0px; margin-top: 10px; margin-bottom:30px; padding-right:0px;">

	<div style="margin-left:0px; margin-right:0px; display: block; margin-left: auto; margin-right: auto; width: 10%;">
		<a href="#">
			<img src="<?= base_url(); ?>assets/login/img/google_play.png" style="width:100%;background-position:center;"
				class="responsive-image center-block">
		</a>
	</div>
