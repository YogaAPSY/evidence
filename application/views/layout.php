...
<head>
	...
	<title>Laporan <?= get_judul_kontrak_by_id($this->uri->segment(3)) ?></title>
	<?php else : ?>
	<title>Welcome To | Sistem Monitoring Kontrak</title>
	...
	<link href="<?= base_url(); ?>assets/AdminBsb/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css"
		rel="stylesheet">
</head>
